        ...
        for jjj = 1:length(traffic_load_sim)
            ...
            switch traffic_load
                case 'low'
                    ylim([0 10])
                    yticks(0:2:10);
                    y_offset = -1;  % Adjust vertical position for alpha labels
                case 'medium'
                    ylim([0 20])
                    yticks(0:5:20);
                    y_offset = -2.0;  % Adjust vertical position for alpha labels
                case 'high'
                    ylim([0 60])
                    yticks(0:20:60);
                    y_offset = -7;  % Adjust vertical position for alpha labels
            end
